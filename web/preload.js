...
contextBridge.exposeInMainWorld(
	'appElectronAPI', 
	{
		...
		setRefs: ( json ) => ipcRenderer.invoke( 'set-refs', json ),
		convert2PDF: ( headers, bodies, pdfPath, preamble, toc ) => ipcRenderer.invoke( 'convert-html-to-pdf', headers, bodies, pdfPath, preamble, toc ),
