...
extension type AppElectronAPI._( JSObject _ ) implements JSObject {
    ...
    external JSPromise< JSAny > setRefs( JSString json );
    external JSPromise< JSAny > convert2PDF( JSArray< JSString > headers, JSArray< JSString > htmlFiles, JSString pdfPath, JSString preamble, JSString toc );
